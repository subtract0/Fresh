"""
CLI command for GetMemoryByType
...
@click.pass_context
def getmemorybytype(ctx, verbose: bool, output: str, config: Optional[str]):
    """
    GetMemoryByType command.
    
    TODO: Implement GetMemoryByType CLI functionality
    ...
    try:
        if verbose:
            console.print(f"[blue]Running GetMemoryByType command...[/blue]")
        ...
        if output == 'json':
            ...
            table = Table(title=f"GetMemoryByType Results")
