...
@click.pass_context
def where(ctx, verbose: bool, output: str, config: Optional[str]):
    """
    where command.
    
    TODO: Implement where CLI functionality
    ...
    try:
        if verbose:
            console.print(f"[blue]Running where command...[/blue]")
