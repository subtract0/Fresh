"""
CLI command for search_by_type
...
@click.pass_context
def search_by_type(ctx, verbose: bool, output: str, config: Optional[str]):
    """
    search_by_type command.
    
    TODO: Implement search_by_type CLI functionality
