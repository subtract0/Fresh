...
class MotherAgent:
    ...
    def _execute_agent(self, agent_type: str, request: SpawnRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            # All models support custom temperature
...
"""
    ...
    def _get_model_name(self, model: str) -> str:
        """Map friendly model names to OpenAI model names, using valid models."""
        model_mapping = {
            "gpt-4": "gpt-4o",  # Use GPT-4o as default for GPT-4
            ...
            "claude-2": "gpt-4o"  # Fallback for Claude to GPT-4o
        }
        # Default to GPT-4o for unrecognized models
